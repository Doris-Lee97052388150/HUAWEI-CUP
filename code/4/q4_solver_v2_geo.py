...
def generate_all_figures(
    ...
    for K in (2,3):
        ...
        if node_xy:
            ...
            plot_geo_routes(reg,sol,data,node_xy,f"fig_q4_{59 if K==2 else 60:02d}_K{K}_geo_routes",dem,latv,lonv)
            plot_geo_routes_relays(reg,sol,data,node_xy,f"fig_q4_{61 if K==2 else 62:02d}_K{K}_geo_routes_relays",dem,latv,lonv)
            if K==2:
                plot_group_geo_detail(reg,sol,1,data,node_xy,"fig_q4_63_K2_group1_geo_detail",dem,latv,lonv)
                plot_group_geo_detail(reg,sol,2,data,node_xy,"fig_q4_64_K2_group2_geo_detail",dem,latv,lonv)
            else:
                plot_group_geo_detail(reg,sol,1,data,node_xy,"fig_q4_65_K3_group1_geo_detail",dem,latv,lonv)
                plot_group_geo_detail(reg,sol,2,data,node_xy,"fig_q4_66_K3_group2_geo_detail",dem,latv,lonv)
                plot_group_geo_detail(reg,sol,3,data,node_xy,"fig_q4_67_K3_group3_geo_detail",dem,latv,lonv)
